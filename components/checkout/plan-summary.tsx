...
export function PlanSummary() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-indigo-400/30 bg-gradient-to-b from-indigo-500/15 via-purple-600/10 to-transparent p-8 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08),0_25px_60px_-15px_rgba(99,102,241,0.4)] backdrop-blur-2xl backdrop-saturate-150">
      <div
        aria-hidden
      ...
      <Badge className="relative border-0 bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-950/50">
        Selected Plan
      </Badge>
